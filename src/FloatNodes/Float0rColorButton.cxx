...
static void float0r_color_button_callback( Float0rColorButton* o, void* data )
{
	o->select_color();
}
		
Float0rColorButton::Float0rColorButton( int x, int y, int w, int h, const char *l )
	: Fl_Button( x, y, w, h, l )
{
	m_instance = 0;
	m_param_index = 0;
	type(5);
	callback( (Fl_Callback*)float0r_color_button_callback );
}
Float0rColorButton::~Float0rColorButton()
{
}
void Float0rColorButton::select_color()
{
	if ( !m_instance ) {
		return;
	}
...
void Float0rColorButton::set_instance( f0r_instance_t i, f0r_set_param_value_f s, f0r_get_param_value_f g, int param_index )
{
	m_instance = i;
