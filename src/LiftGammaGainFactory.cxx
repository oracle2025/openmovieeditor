...
namespace nle
{
LiftGammaGainFactory* g_liftGammaGainFactory;

LiftGammaGainFactory::LiftGammaGainFactory()
{
	g_liftGammaGainFactory = this;
}
LiftGammaGainFactory::~LiftGammaGainFactory()
{
}
FilterBase* LiftGammaGainFactory::get( Clip* clip )
{
	...
	return new LiftGammaGainFilter( effectClip->w(), effectClip->h() );
}
	
const char* LiftGammaGainFactory::name()
{
